                                                        ...
                                                        <ul class="nav nav-sm flex-column">
                                                            <li class="nav-item">
                                                                <a href="apps-job-candidate-lists.html"
                                                                    class="nav-link" data-key="t-list-view">
                                                                    List View
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="apps-job-candidate-grid.html"
                                                                    class="nav-link" data-key="t-grid-view">
                                                                    Grid View</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarBlogs" class="nav-link" data-bs-toggle="collapse"
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="../../../../themeforest.net/item/velzon-aspnet-core-admin-dashboard-template/36077495a308.html"
