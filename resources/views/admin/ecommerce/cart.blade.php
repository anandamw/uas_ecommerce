                                    ...
                                    <table class="table align-middle mb-0 table-nowrap">
                                        ...
                                        <tbody>
                                            <tr class="product">
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="ecommerce-product-detail.html" class="text-dark">Half
                                                            sleeve T-shirt</a></h5>
                                            ...
                                            <tr class="product">
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="ecommerce-product-detail.html" class="text-dark">Light
                                                            blue T-shirt</a></h5>
                                            ...
                                            <tr class="product">
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="ecommerce-product-detail.html" class="text-dark">Black
                                                            Color T-shirt</a></h5>
                                            ...
                                            <tr class="product">
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="ecommerce-product-detail.html" class="text-dark">Half
                                                            sleeve T-Shirt</a></h5>
                                                    <p class="mb-0">Color : <span class="fw-medium">Light orange</span>
                                                    </p>
                                                </td>
