                                    ...
                                    <div id="rating-filter">
                                        <div class="form-check mt-2">
                                            ...
                                            <label class="form-check-label" for="productratingCheck1">
                                                <span class="rate-value">4</span> <i class="bx bxs-star text-warning"></i> &
                                                Above
                                            </label>
                                        </div>
                                        <div class="form-check mt-2">
                                            ...
                                            <label class="form-check-label" for="productratingCheck2">
                                                <span class="rate-value">3</span> <i class="bx bxs-star text-warning"></i>
                                                & Above
                                            </label>
                                        </div>
                                        <div class="form-check mt-2">
                                            ...
                                            <label class="form-check-label" for="productratingCheck3">
                                                <span class="rate-value">2</span> <i class="bx bxs-star text-warning"></i>
                                                & Above
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check mt-2">
                                            ...
                                            <label class="form-check-label" for="productratingCheck4">
                                                <span class="rate-value">1</span> <i class="bx bxs-star text-warning"></i>
                                                & Above
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="nav nav-pills product-view-nav justify-content-end mt-3 mt-sm-0">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#"><i
                                                    class="bx bx-grid-alt align-middle"></i></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#"><i
                                                    class="bx bx-list-ul align-middle"></i></a>
                                        </li>
                                    </ul>
                                </form>
                            </div>
