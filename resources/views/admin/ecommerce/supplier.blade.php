                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7">
                                    <div class="p-4 text-center text-xl-start">
                                        ...
                                        <div class="mt-4">
                                            <a href="javascript: void(0);" class="text-decoration-underline text-reset">See
                                                Profile <i class="mdi mdi-arrow-right"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="text-center p-4 border-end">
                                        <div class=" avatar-sm mx-auto mb-3 mt-1">
                                            <span
                                                class="avatar-title rounded-circle bg-warning-subtle text-warning font-size-16">
                                                T
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="text-center p-4 border-end">
                                        <div class=" avatar-sm mx-auto mb-3 mt-1">
                                            <span
                                                class="avatar-title rounded-circle bg-danger-subtle text-danger font-size-16">
                                                L
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="text-center p-4 border-end">
                                        <div class=" avatar-sm mx-auto mb-3 mt-1">
                                            <span
                                                class="avatar-title rounded-circle bg-success-subtle text-success font-size-16">
                                                P
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="text-center p-4 border-end">
                                        <div class=" avatar-sm mx-auto mb-3 mt-1">
                                            <span
                                                class="avatar-title rounded-circle bg-dark-subtle text-dark text-light font-size-16">
                                                H
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5">
                                    <div class="text-center p-4 border-end">
                                        <div class=" avatar-sm mx-auto mb-3 mt-1">
                                            <span
                                                class="avatar-title rounded-circle bg-dark-subtle text-body font-size-16">
                                                T
                                            </span>
                                        </div>
                                        <h5 class="text-truncate pb-1">Tech Hifi</h5>
