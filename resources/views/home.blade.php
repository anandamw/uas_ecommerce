            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="{{ asset('') }}assets_user/images/vegetable/banner/1.jpg"
                        ...
                        <div class="home-detail p-center-left w-75">
                            <div>
                                ...
                                <p class="w-75 d-none d-sm-block">
                                    Dengan membaca, kita menanam benih pengetahuan yang kelak akan berbuah di masa depan
                                    dengan bahagia.
                                </p>
                                <button onclick="location.href = 'produk_review.html';"
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('') }}assets_user/images/vegetable/banner/2.jpg"
                                    class="bg-img blur-up lazyload" alt="" />
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('') }}assets_user/images/vegetable/banner/3.jpg"
                                    class="bg-img blur-up lazyload" alt="" />
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
                        ...
                        <div class="slider-9 book-category-slider">
                            <div>
                                <a href="kategori_produk.html" class="category-box wow fadeInUp">
                                    <img src="{{ asset('') }}assets_user/images/book/category/1.jpg" class="img-fluid"
                                        alt="">
                                </a>
                            </div>
                        ...
                        <div class="product-image">
                            <div class="front">
                                <a href="produk_detail.html">
                                    <img src="{{ asset('') }}assets_user/images/book/product/31.jpg"
                ...
                <div class="col-xxl-3 col-lg-4 d-lg-block d-none">
                    <div class="ratio_156">
                        <div class="banner-contain-2 hover-effect">
                            <img src="{{ asset('') }}assets_user/images/book/banner/3.jpg"
                                class="bg-img blur-up lazyload" alt="">
                        </div>
                    </div>
                </div>
